    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 flex-1">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200 shadow-sm hover:shadow-md transition-shadow h-full">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-7 h-7 bg-green-500 rounded-lg flex items-center justify-center">
                <TrendingUp className="w-3.5 h-3.5 text-white" />
              </div>
              <p className="text-xs font-semibold text-green-800">This Month</p>
            </div>
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border-2 border-orange-200 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-orange-400 hover:ring-2 hover:ring-orange-300 hover:ring-offset-1 transition-all duration-200 h-full">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-7 h-7 bg-orange-500 rounded-lg flex items-center justify-center">
                <AlertCircle className="w-3.5 h-3.5 text-white" />
              </div>
              <p className="text-xs font-semibold text-orange-800">Outstanding</p>
            </div>
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200 shadow-sm hover:shadow-md transition-shadow h-full">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-7 h-7 bg-blue-500 rounded-lg flex items-center justify-center">
                <DollarSign className="w-3.5 h-3.5 text-white" />
              </div>
              <p className="text-xs font-semibold text-blue-800">Total (All Time)</p>
            </div>
